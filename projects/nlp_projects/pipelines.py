####
# Original Code is from https://github.com/patil-suraj/question_generation
# Modified to solve custom problems
####
...
def load_nlp(nlp_model: str = "en_core_web_sm"):
    return spacy.load(nlp_model)


def sent_tokenize(text: str, nlp=load_nlp()):
    doc = nlp.pipe(text)
