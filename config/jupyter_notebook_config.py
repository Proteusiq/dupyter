...
## The directory to use for notebook and kernels.
...
## The base name used when creating untitled notebook.
...
#  
#  Provides facilities for reading, writing, and copying both notebook and
#  generic files.
#  
...
## By default notebook are saved on disk on a temporary file and then if
...
## The hashing algorithm used to sign notebook.
...
## The secret key with which notebook are signed.
